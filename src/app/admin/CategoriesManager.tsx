...
export default function CategoriesManager() {
  const { categories, loading, addCategory, removeCategory, updateCategory } = useCategories();
        ...
        {loading ? (
          ...
          <ul className="divide-y divide-gray-100">
            {categories.map((cat) => {
              ...
              return (
                <li key={cat.id} className="flex items-center gap-4 px-6 py-3.5 hover:bg-gray-50/50 transition-colors group">
